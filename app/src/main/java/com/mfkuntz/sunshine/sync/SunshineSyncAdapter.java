package com.mfkuntz.sunshine.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static void syncImmediately(Context context) {
        ...
        Account a = getSyncAccount(context);
        ContentResolver.requestSync(a, context.getString(R.string.content_authority), bundle);
    }
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APIKEY_PARAM, getContext().getString(R.string.api_key_openweather))
                    .build();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                Notifications.NotifyWeather(getContext(), false);
            }
